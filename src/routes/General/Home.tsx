...
const Home = () => {
  ...
  const { data: resCustomerType } = useQuery("get typs", () =>
    CustomerTypeRequest(0, "", "", "")
  );
  ...
  return (
    <>
      ...
      <div className="container-lg text-center">
        <h2 className="mt-5 py-3 px-6 border border-primary rounded bg-light text-cyan-800">
          ...
          <tbody>
            <tr>
              ...
              <td className="text-center">
                {resBookCategories?.data.totalCategories}
              </td>
            </tr>
            <tr>
              <td>Types of customers</td>
              <td className="text-center">
                {resCustomerType?.data.totalTypes}
              </td>
            </tr>
          </tbody>
        </table>
